...
export const DATA_MODEL = {
	...
	"s" : { "active": true, "type": "string", "description": "Symbol" },
	"p" : { "active": true, "type": "string", "description": "Price change" },
	...
	"v" : { "active": false, "type": "string", "description": "Total traded base asset volume" },
	"q" : { "active": false, "type": "string", "description": "Total traded quote asset volume" },
	...
	"n" : { "active": false, "type": "integer", "description": "Total number of trades" }
}
...
export function aggregate(prevTrades, eventTrades) {
	...
	let mappedNews = eventTrades?.reduce((acc, cur) => {
		acc[cur.s] = {
			...cur,
			isNew: true,
		};
